return {
  ...
  config = function(plugin, opt)
    require "plugins.configs.nvim-autopairs"(plugin, opt) -- include the default astronvim config that calls the setup call
    ...
    npairs.add_rules {
      ...
      -- 等号自动补空格 "c", "cpp", "javascript", "typescript" ,"php", "python"
      Rule("=", "", { "-html", "-rust" })
        :with_pair(cond.not_inside_quote())
        :replace_endpair(function(opts)
          local prev_2char = opts.line:sub(opts.col - 2, opts.col - 1)
      ...
      Rule("<", "", { "-rust" })
        ...
        :replace_endpair(function(opts)
          ...
          if prev_2char:match "%<$" then return " " end
          if prev_2char:match "%S$" then return "<bs> <" .. " " end
          if prev_2char:match "<" then return "<bs><bs><" .. " " end
          return " "
        end)
        :set_end_pair_length(0)
        :with_move(cond.none())
      ...
      Rule("=", "", { "rust" })
        ...
        :replace_endpair(function(opts)
          ...
          local flag = false
          local line = opts.line
          if line:match " if " or line:match " while " then flag = true end
